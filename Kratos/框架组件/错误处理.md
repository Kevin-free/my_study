...
### 安装工具[#](https://go-kratos.dev/docs/component/errors#安装工具)
...
### 错误定义[#](https://go-kratos.dev/docs/component/errors#错误定义)
...
### 错误生成[#](https://go-kratos.dev/docs/component/errors#错误生成)
...
### 使用方式[#](https://go-kratos.dev/docs/component/errors#使用方式)

#### 响应错误[#](https://go-kratos.dev/docs/component/errors#响应错误)
...
#### 错误断言[#](https://go-kratos.dev/docs/component/errors#错误断言)
