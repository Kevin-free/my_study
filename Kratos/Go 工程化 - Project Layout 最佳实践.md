...
### Kit 基础库[#](https://go-kratos.dev/blog/go-project-layout#kit-基础库)
...
### Application 应用项目[#](https://go-kratos.dev/blog/go-project-layout#application-应用项目)
...
![kratos ddd](https://go-kratos.dev/images/ddd.jpg)
...
### 应用类型[#](https://go-kratos.dev/blog/go-project-layout#应用类型)
...
## 应用目录[#](https://go-kratos.dev/blog/go-project-layout#应用目录)

### /cmd[#](https://go-kratos.dev/blog/go-project-layout#cmd)
...
### /internal[#](https://go-kratos.dev/blog/go-project-layout#internal)
...
### /pkg[#](https://go-kratos.dev/blog/go-project-layout#pkg)
...
## 服务应用目录[#](https://go-kratos.dev/blog/go-project-layout#服务应用目录)

### /api[#](https://go-kratos.dev/blog/go-project-layout#api)

 API 协议定义目录，services.proto protobuf 文件，以及生成的 go 文件。我们通常把 api 文档直接在 proto 文件中描述。

### /configs[#](https://go-kratos.dev/blog/go-project-layout#configs)

 配置文件模板或默认配置。

### /test[#](https://go-kratos.dev/blog/go-project-layout#test)

 额外的外部测试应用程序和测试数据。你可以随时根据需求构造 /test 目录。对于较大的项目，有一个数据子目录是有意义的。例如，你可以使用 /test/data 或 /test/testdata (如果你需要忽略目录中的内容)。请注意，Go 还会忽略以 “.” 或 “_” 开头的目录或文件，因此在如何命名测试数据目录方面有更大的灵活性。

## 服务内部目录[#](https://go-kratos.dev/blog/go-project-layout#服务内部目录)
...
## 参考文献[#](https://go-kratos.dev/blog/go-project-layout#参考文献)
